...
docker tag -f pseudogene/docker-stacks:cli pseudogene/docker-stacks:1.48
docker tag -f pseudogene/docker-stacks:cli pseudogene/docker-stacks:1.48-cli
docker tag -f pseudogene/docker-stacks:cli pseudogene/docker-stacks:latest

cd gui
docker build -t pseudogene/docker-stacks:gui .
docker tag -f pseudogene/docker-stacks:gui pseudogene/docker-stacks:1.48-gui
